...
public class AnglingSounds {
    ...
    public static void init() {
        SOUNDS.forEach(sound -> Registry.register(BuiltInRegistries.SOUND_EVENT, sound.getLocation(), sound));
    }

    private static SoundEvent create(String id) {
        SoundEvent soundEvent = SoundEvent.createVariableRangeEvent(new ResourceLocation(MOD_ID, id));
